...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  // Crop Preferences (Restricted to Tomato, Onion, Paddy (Rice), Chilli, Maize)
  const availableCrops = ['Tomato', 'Onion', 'Paddy (Rice)', 'Chilli', 'Maize'];
  const [preferredCrops, setPreferredCrops] = useState<string[]>(['Tomato', 'Onion', 'Paddy (Rice)']);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden border border-slate-200">
        ...
        <div className="p-6 max-h-[calc(85vh-100px)] overflow-y-auto space-y-5">
          ...
          <div className="rounded-2xl p-3.5 space-y-2 border bg-emerald-50/80 border-emerald-200">
            <div className="flex items-center justify-between font-extrabold text-xs text-emerald-950">
              <div className="flex items-center space-x-2">
                <Sparkles className="w-4 h-4 text-amber-600" />
                <span>Instant Demo Access</span>
              </div>
              <span className="text-[10px] text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-full font-bold">1-Click Test</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                ...
                className="w-full p-2.5 bg-white hover:bg-emerald-100/80 text-emerald-950 font-black text-xs rounded-xl border border-emerald-300 shadow-xs transition flex items-center justify-center space-x-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full p-2.5 bg-white hover:bg-blue-100/80 text-blue-950 font-black text-xs rounded-xl border border-blue-300 shadow-xs transition flex items-center justify-center space-x-2 cursor-pointer"
              >
            ...
            <button
              ...
              className="w-full p-2 bg-slate-900 hover:bg-slate-800 text-white font-black text-xs rounded-xl border border-slate-700 shadow-xs transition flex items-center justify-center space-x-2 cursor-pointer"
            >
